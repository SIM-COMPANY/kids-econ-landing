...
const CURRICULUM = [
  ...
  },
  {
    ...
    week: '1주차',
    time: '평택 오프',
    title: "첫 만남, '내 용돈'이 생긴다",
    bullets: [
      '얼굴 트기 · 엉클조·부모·아이 첫 신뢰',
      '우리 아이 적정 용돈을 엉클조와 함께 가늠',
      '용돈 계약서 쓰기 · 돼지 저금통 준비',
      '🎯 미션: 한 주 용돈 써보기 — 가장 망설였던 소비 하나 기억해 오기',
    ],
  },
  {
    badge: '②',
    week: '2주차',
    time: '줌 회고',
    title: '"잘 모으면 좋은 일이?" 회고',
    bullets: [
      '해온 경험 나누기',
      '주사위(윷) 놀이 — 잔고를 지키면 앞으로, 다 쓰면 뒤로',
      '보너스의 의미 (남기면 더 받는다)',
      "🎯 미션: 한 주 용돈 안에서 '얼마 남았나' 매일 세어 오기",
    ],
  },
  {
    badge: '③',
    week: '3주차',
    time: '줌 회고',
    title: '"다 가지려다 다 잃을라" 회고',
    bullets: [
      '다른 집 이야기까지 나누기',
      '이솝우화 (고깃덩어리 문 개 · 여우와 포도)',
      '기회비용 — 하나를 고르면 하나를 포기',
      "🎯 미션: 산 것에 '사길 잘함/아쉬움' 표시해 오기",
    ],
  },
  {
    badge: '④',
    week: '4주차',
    time: '평택 오프 · 여러 가정 함께',
    title: '"같은 돈, 뭐가 더 좋을까" 경매 모임',
    bullets: [
      '경매 놀이 — 정해진 돈으로 갖고 싶은 것 겨루기',
      '같은 돈인데 더 갖고 싶은 게 있다는 발견',
      '🎯 미션: 사고 싶은 것 2개 중 하나만 골라 오기',
    ],
  },
  {
    badge: '⑤',
    ...
    title: '"가격을 본다" 회고',
    bullets: [
      '함께 장 보기 — 물건 구입, 가격의 이해',
      '아이가 좋아하는 것 vs 엄마가 필요한 것, 가격 비교',
      '좋은 선택과 후회하는 선택',
  ...
  },
  {
    ...
    week: '6주차',
    time: '줌 회고',
    title: '"안 보이는 곳에 모으기" 회고',
    bullets: [
      '통장 만들기 · (체크카드) 안내',
      '용돈 일부는 통장에, 일부는 현금으로',
      '손에 쥔 돈과 모아둔 돈의 차이',
      "🎯 미션: 이번 주 용돈에서 '조금' 떼어 모아 오기",
    ],
  },
  {
    badge: '⑦',
    week: '7주차',
    time: '줌 회고',
    title: '"비싼 게 꼭 중요한 건 아니야" 회고',
    bullets: [
      '물과 공기의 가격 (동화 활용)',
      '가격 ≠ 가치 · 원가의 개념 쉽게',
      '꼭 필요한 것과 비싼 것은 다르다',
      "🎯 미션: 우리 집에서 '싼데 소중한 것' 하나 찾아 오기",
    ],
  },
  {
    badge: '⑧',
    week: '8주차',
    time: '줌 회고',
    title: '"지금 살 것, 다음에 살 것" 회고',
    bullets: [
      '쇼핑 리스트 만들기',
      '지금 / 다음 용돈날까지의 가까운 시간으로 나누기',
      '지금 사야 할 것과 기다려도 되는 것',
      "🎯 미션: '지금 / 다음에' 두 칸으로 갖고 싶은 것 적어 오기",
    ],
  },
  {
    badge: '⑨',
    week: '9주차',
    time: '줌 회고',
    title: '"당장 다 쓰면 나중엔 없어" 회고',
    bullets: [
      '이솝우화 (황금알을 낳는 거위)',
      '눈앞의 욕심보다 계속 생기는 것을 보기',
      '다음 주를 위해 조금 남겨두는 연습',
      "🎯 미션: 갖고 싶은 것을 용돈 안에서 '한 번 기다려보기'",
    ],
  },
  {
    badge: '⑩',
    week: '10주차',
    time: '평택 오프 · 자녀 동반',
    title: '우리 집 소비 원칙, 수료 회고',
    bullets: [
      '가족의 소비 — 당일/1박 여행 예산 세워보기',
      '예산 vs 실제 지출 돌아보기 (예측보다 회고에 무게)',
      '가장 잘한 소비 · 아쉬운 소비 나누기',
      '우리 집 소비 원칙 선언 · 엉클조의 한마디',
      "🎯 수료 미션: '우리 집 소비 원칙' 한 줄 + 앞으로의 다짐",
    ],
  },
];
