    ...
    <div style={{ fontFamily: "'Apple SD Gothic Neo','Noto Sans KR','맑은 고딕',sans-serif", background: C.bg, minHeight: '100vh', color: C.text }}>
      ...
      <section style={{ padding: '72px 24px', background: C.bg }}>
        <div style={{ maxWidth: '580px', margin: '0 auto' }}>
          ...
          {[
            {
              emoji: '👦', name: '아들 형찬이', sub: '초등학교 때 현대자동차 주식을 샀습니다',
              body: <>
                "아는 회사 말해봐" 했더니 현대자동차를 골랐습니다.<br />
                주주가 되니 뉴스를 찾아보고, 회사를 공부했습니다.<br />
                그 아이가 지금 <strong>현대자동차에서 일하고 있습니다.</strong>
              </>,
              quote: '"좋아하는 회사 주주가 되니까 저절로 공부하게 됐어요."',
            },
            {
              emoji: '👧', name: '딸 은세미', sub: '초등학교 때부터 용돈 기입장·적금을 했습니다',
              body: <>
                용돈을 스스로 관리하면서 자립심이 생겼습니다.<br />
                크고 나서 스스로 중국 유학을 결정했고,<br />
                <strong>칭화대에 진학했습니다.</strong>
              </>,
              quote: '어릴 때 자기 돈을 스스로 다뤄본 경험이 나중에 큰 결정을 스스로 하는 힘이 됐습니다.',
            },
          ].map((c, i) => (
            <div key={i} style={{
