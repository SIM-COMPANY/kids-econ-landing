...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'Apple SD Gothic Neo','Noto Sans KR','맑은 고딕',sans-serif", background: C.bg, minHeight: '100vh', color: C.text }}>
      ...
      <section style={{ padding: `${S.section} ${S.md}`, background: C.surface }}>
        <div style={{ maxWidth: '640px', margin: '0 auto' }}>
          <p style={{ color: C.primary, fontWeight: 700, fontSize: T.caption, letterSpacing: '0.08em', textTransform: 'uppercase', textAlign: 'center', marginBottom: S.xs }}>
            실제 이야기
          </p>
          <h2 style={{ fontSize: T.h2, fontWeight: 700, textAlign: 'center', marginBottom: S.lg, letterSpacing: '-0.02em', lineHeight: 1.4 }}>
            엉클조 두 아이의 20년 전 이야기
          </h2>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: S.sm, marginBottom: S.sm }}>
            {/* Before */}
            <div style={{ background: C.bg, border: `1px solid ${C.border}`, borderRadius: '16px', padding: `${S.md} ${S.md}`, boxShadow: '0 1px 4px rgba(0,0,0,0.05)' }}>
              <p style={{ fontSize: T.caption, color: C.textMuted, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: S.sm }}>Before</p>
              <p style={{ fontSize: T.small, color: C.textSub, lineHeight: 1.75 }}>
                초등 때부터<br />주간 용돈을 받고<br />용돈기입장을 썼습니다
              </p>
            </div>
            {/* After */}
            <div style={{ background: C.orange10, border: `1px solid ${C.orange20}`, borderRadius: '16px', padding: `${S.md} ${S.md}` }}>
              <p style={{ fontSize: T.caption, color: C.primary, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: S.sm }}>After</p>
              <p style={{ fontSize: T.body, fontWeight: 700, color: C.dark, lineHeight: 1.7 }}>
                5년 뒤<br />주식 수익 <span style={{ color: C.primary }}>+400%</span>
              </p>
              <p style={{ fontSize: T.small, color: C.textSub, marginTop: S.xs, lineHeight: 1.65 }}>
                스스로 판단하고<br />결정하는 어른이 됐습니다
              </p>
            </div>
          </div>
          {/* 엉클조 코멘트 */}
          <div style={{
            ...
            padding: `${S.sm} ${S.md}`, boxShadow: '0 1px 4px rgba(0,0,0,0.05)',
            display: 'flex', gap: S.sm, alignItems: 'center',
          }}>
            <img
              src="/uncle-jo.png"
              alt="엉클조"
              style={{ width: '40px', height: '40px', borderRadius: '50%', objectFit: 'cover', border: `2px solid ${C.primary}`, flexShrink: 0 }}
            />
            <p style={{ fontSize: T.small, color: C.textSub, lineHeight: 1.75, letterSpacing: '-0.01em' }}>
              "지금 와서 보면, 돈 공부보다 <strong style={{ color: C.dark }}>선택하고 책임지는 연습</strong>이 더 컸더라고요."
              <br /><span style={{ fontSize: T.caption, color: C.textMuted }}>— 엉클조</span>
            </p>
          </div>
        </div>
      </section>
      ...
      {/* ══ 푸터 ══ */}
      <footer style={{ padding: `56px ${S.md}`, background: C.dark, color: '#bbb' }}>
        <div style={{ maxWidth: '640px', margin: '0 auto' }}>
          <p style={{ lineHeight: 1.9, fontSize: T.body, marginBottom: S.md, letterSpacing: '-0.01em' }}>
            20년 동안 수많은 분들께<br />
            돈과 생애설계, 행복을 주제로 이야기했습니다.<br />
            <br />
            그 경험을 나눠드리고 싶어 이 모임을 엽니다.
          </p>
          <p style={{ color: C.darkTextMuted, fontSize: T.small, letterSpacing: '-0.01em' }}>— 엉클조 (조경만)</p>
        </div>
      </footer>
